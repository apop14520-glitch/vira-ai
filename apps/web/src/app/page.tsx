        ...
        <section className="relative overflow-hidden rounded-3xl border border-slate-800 bg-slate-900/80 p-5 shadow-2xl shadow-cyan-950/10 sm:p-8">
          ...
          <div className="relative max-w-3xl">
            ...
            <div className="mt-5 flex flex-col gap-2 sm:flex-row sm:items-center">
              ...
              <Link href="/sites" className="inline-flex min-h-11 items-center justify-center rounded-xl border border-slate-700 px-4 py-3 text-sm font-bold text-slate-200 transition hover:border-cyan-400/60 hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-cyan-300/70">Abrir VIRA Sites</Link>
            </div>
          </div>
        </section>
