  ...
  return (
    <AppShell>
      <div className="space-y-6">
        <section className={`overflow-hidden rounded-3xl border bg-gradient-to-br p-6 sm:p-8 ${toneClasses[module.tone]}`}>
        ...
        <section className="grid gap-4 md:grid-cols-3">
          {module.capabilities.map((capability) => (
            <div key={capability} className="rounded-2xl border border-slate-800 bg-slate-900/45 p-5">
              <span className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-600">Área reservada</span>
        ...
        <section className="rounded-2xl border border-dashed border-slate-700 bg-slate-900/25 p-6 sm:p-8">
