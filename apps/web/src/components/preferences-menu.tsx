...
const sectionCopy: Record<SectionId, { title: string; description: string }> = {
  ...
  connections: { title: "Conexões", description: "Integrações externas do VIRA.AI." },
